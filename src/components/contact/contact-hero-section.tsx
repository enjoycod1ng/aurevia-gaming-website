  ...
  return (
    <section className="scroll-reveal flex min-h-[calc(100svh-6rem)] items-center bg-[radial-gradient(circle_at_88%_18%,rgb(212_175_55/0.12),transparent_28rem)] py-10 md:py-14" data-scroll-reveal>
      <div className="container grid grid-cols-1 items-center gap-10 xl:grid-cols-[minmax(0,0.96fr)_minmax(580px,1.04fr)] xl:gap-20">
        <div>
          <p className="mb-8 inline-flex min-h-10 items-center rounded-full border border-line-strong bg-surface-strong px-6 text-sm font-extrabold text-gold-bright uppercase">{content.hero.label}</p>
          <h1 className="max-w-162.5 heading-1">{content.hero.title}</h1>
          ...
          <div className="mt-13.5 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <span className="grid min-w-0 gap-1">
                <small className="text-sm font-bold tracking-[0.08em] text-muted uppercase">Telegram</small>
                <strong className="wrap-anywhere text-base">{contact.telegramHandle}</strong>
                <em className="mt-3 text-sm not-italic text-muted">{content.hero.telegramDescription}</em>
              </span>
            </a>
            <a
            ...
            >
              ...
              <span className="grid min-w-0 gap-1">
                <small className="text-sm font-bold tracking-[0.08em] text-muted uppercase">WhatsApp</small>
                <strong className="wrap-anywhere text-base">{contact.phoneDisplay}</strong>
                <em className="mt-3 text-sm not-italic text-muted">{content.hero.whatsappDescription}</em>
              </span>
            </a>
          </div>
        </div>
