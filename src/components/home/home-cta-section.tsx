  ...
  return (
    ...
    >
      <div className="container">
        <div className="grid min-h-95 grid-cols-1 items-center gap-11 overflow-hidden rounded-[26px] border border-gold/40 bg-[radial-gradient(circle_at_93%_10%,rgb(212_175_55/0.18),transparent_55%),var(--color-surface)] px-6.5 py-10 md:px-13.5 md:py-15 lg:grid-cols-[minmax(0,1fr)_340px] lg:gap-20">
          <div>
            <h2 className="max-w-175 heading-2">{content.title}</h2>
